...
int main(void)
{
  ...
  MX_TIM1_Init();
  /* USER CODE BEGIN 2 */
	write_digit(positions[0], simple_digits[0]);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|DS_SHIFT_Pin|DS_DATA_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : BTN_START_STOP_Pin */
  GPIO_InitStruct.Pin = BTN_START_STOP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(BTN_START_STOP_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : LD2_Pin DS_SHIFT_Pin DS_DATA_Pin */
  GPIO_InitStruct.Pin = LD2_Pin|DS_SHIFT_Pin|DS_DATA_Pin;
